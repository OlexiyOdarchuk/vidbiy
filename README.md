...
**[⬇ Завантажити APK](../../releases/latest)**
...
Потрібні JDK 21+ і Android SDK (compileSdk 36).
...
Для Windows можна запустити `build-apk.bat` подвійним кліком або з термінала. Він збере release APK у `app\build\outputs\apk\release\app-release.apk`.

Інтерфейс навмисно зроблений кислотним і перевантаженим: яскраві кольори, товсті рамки, блок мемів та декоративний «Потужнометр».
